...
- (void)viewDidLoad
{
    ...
    self.translateButton.layer.cornerRadius = self.translateButton.frame.size.height/2;
    self.translateButton.clipsToBounds = YES;
    self.detectButton.layer.cornerRadius = self.  detectButton.frame.size.height/2;
    self.detectButton.clipsToBounds = YES;
    self.supportButton.layer.cornerRadius = self.detectButton.frame.size.height/2;
    self.supportButton.clipsToBounds = YES;
